 ...
 */
@Entity
@Table(name = "T_WB_SWRYXX", schema = "PSOPUSER")
public class TWbSwryxx implements java.io.Serializable {
	...
	/** minimal constructor */
	public TWbSwryxx(String dszykzj, String zjhm, String swsj, String scrzyksj, String dsbs, Date updateTime) {
	...
	public TWbSwryxx(String dszykzj, String swryxm, String zjlx, String zjhm, String swsj, String xwsj, String zdh,
			String yycsdm, String scrzyksj, String zykzhxgsj, String dsbs, String scrhjksj, Date updateTime) {
		this.dszykzj = dszykzj;
		this.swryxm = swryxm;
		this.zjlx = zjlx;
		this.zjhm = zjhm;
