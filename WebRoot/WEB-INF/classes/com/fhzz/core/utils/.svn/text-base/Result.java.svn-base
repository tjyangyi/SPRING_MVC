...
public class Result implements java.io.Serializable {
	...
	public static Result getSuccessInstance(Object response) {
	...
	public static Result getFailureInstance(Object response) {
		return new Result(STATE_FAILURE, INFO_FAILURE, response);
	}
